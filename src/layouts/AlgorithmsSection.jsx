...
import {faSort, faSearch, faProjectDiagram, faTree} from '@fortawesome/free-solid-svg-icons';


const AlgorithmsSection = ({onAlgorithmClick}) => {

    const icons = [faSort, faSearch, faProjectDiagram, faTree];

    return (
        <section className="pt-28 pb-20  w-full flex flex-col items-center justify-center">
            <div className="w-[1300px] flex flex-col">
                <h2 className="text-2xl font-bold">Popular Algorithm Categories</h2>
