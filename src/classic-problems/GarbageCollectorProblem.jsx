...
const GarbageCollectorProblem = () => {
    return (
        <div>
            <Paragraph content={"The Garbage Collector Problem involves optimizing multiple agents collecting garbage efficiently across a distributed area."} />
...
export default GarbageCollectorProblem;
