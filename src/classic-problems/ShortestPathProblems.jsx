...
const ShortestPathProblems = () => {
    return (
        <div>
            <Paragraph content={"Shortest Path Problems include classic algorithms like Dijkstra, Bellman-Ford, and A* for finding optimal paths in graphs."} />
...
export default ShortestPathProblems;
